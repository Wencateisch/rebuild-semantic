    ...
    <Container className='getMob'>
        <Grid stackable centered doubling>
            ...
            <GridColumn width={6} className='Links' >
                ...
                <button className='getit'><a href='https://www.apple.com/app-store' target='_blank'><Icon name='apple' ></Icon>Download it on <br/> <b>App Store</b></a></button> &nbsp;&nbsp;&nbsp;
                <button className='getit play'><a href='https://play.google.com' target='_blank'><Icon name='google play'></Icon>Get it on <b>Google <br/>Play</b></a></button>
            </GridColumn>
